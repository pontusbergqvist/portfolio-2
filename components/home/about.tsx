	...
	return (
		<section className="my-8 flex flex-col">
			<main>
				...
				<p className="indent-4 mt-2">I am a full-stack web developer from Gothenburg, Sweden. Currently I am pursuing university studies, graduating in 2022. My interests include <span className="text-accent">React</span>, <span className='text-accent'>TypeScript</span> and <span className='text-accent'>web design</span>!</p>
			</main>
