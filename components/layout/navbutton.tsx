...
const NavButton = ({ active, setActive }: Props) => {
  ...
  return (
    <div className='md:hidden cursor-pointer fixed z-20 after:h-[50px] after:w-[50px] after:block after:bg-accent skew-x-3'>
      <svg
        width="70"
        height="50"
        ...
        id="svg14379">
        <path
          className='stroke-light dark:stroke-dark default-animation faster elay-first'
          style={bottomLine}
          d="M 3.9687501,5.6885419 H 14.552081"
          id="path16385-6-5" />
        <path
          className='stroke-light dark:stroke-dark default-animation'
          style={upperLine}
          ...
          id="path16385-6-5-1" />
        <path
          className='stroke-light dark:stroke-dark default-animation faster delay-last'
          style={bottomLine}
