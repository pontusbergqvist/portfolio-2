...
const ThemeButton = () => {
	...
	return !ssr ? (
          ...
          <div
            className='absolute h-[24px] w-[24px] border-2 left-[-2px] bg-light border-dark rounded-full top-1/2 translate-y-[-50%] transition-transform duration-300 ease-out dark:translate-x-[26px] dark:bg-dark dark:border-light'
          ></div>
        </div>
			)
	 : <div></div>;	
